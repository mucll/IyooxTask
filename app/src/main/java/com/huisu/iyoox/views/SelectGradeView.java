...
public class SelectGradeView extends FrameLayout implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public SelectGradeView(Context context, AttributeSet attrs, int defStyleAttr) {
