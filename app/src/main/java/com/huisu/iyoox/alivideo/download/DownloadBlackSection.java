...
import com.huisu.iyoox.alivideo.sectionlist.SectionParameters;
import com.huisu.iyoox.alivideo.sectionlist.StatelessSection;
...
public class DownloadBlackSection extends StatelessSection {
    ...
    public DownloadBlackSection(Context context, String tag, String title,
                                ArrayList<AlivcDownloadMediaInfo> alivcDownloadMediaInfos) {
        super(SectionParameters.builder()
            .itemResourceId(R.layout.alivc_download_item_black)
            .headerResourceId(R.layout.alivc_download_section_item_black)
            .build());
