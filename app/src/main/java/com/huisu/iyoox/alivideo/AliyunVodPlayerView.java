...
import com.huisu.iyoox.alivideo.gesture.GestureView;
import com.huisu.iyoox.alivideo.guide.GuideView;
import com.huisu.iyoox.alivideo.interfaces.ViewAction;
import com.huisu.iyoox.alivideo.more.SpeedValue;
import com.huisu.iyoox.alivideo.quality.QualityView;
import com.huisu.iyoox.alivideo.speed.SpeedView;
import com.huisu.iyoox.alivideo.theme.ITheme;
import com.huisu.iyoox.alivideo.tipsview.TipsView;
import com.huisu.iyoox.alivideo.utils.ImageLoader;
import com.huisu.iyoox.alivideo.utils.NetWatchdog;
import com.huisu.iyoox.alivideo.utils.OrientationWatchDog;
...
public class AliyunVodPlayerView extends RelativeLayout implements ITheme {
    ...
    private void initVideoView() {
        ...
        mControlView.setTitleBarCanShow(true);
    }
...
//        mOrientationWatchDog.setOnOrientationListener(new AliyunVodPlayerView.InnerOrientationListener(this));
            ...
            public void onContinuePlay() {
                ...
                if (mAliyunVodPlayer.getPlayerState() == PlayerState.Idle ||
                    ...
                    if (mAliyunPlayAuth != null) {
                        ...
                        mControlView.show();
                        mControlView.setTitleBarCanShow(true);
                        mControlView.setControlBarCanShow(false);
                    }
                } else {
                    start();
                }
    ...
    private void initCoverView() {
        ...
        mCoverView.setImageResource(R.drawable.video_play_bg);
