...
public class PolyvPlayerPreviewView extends RelativeLayout {
    ...
    private void initViews() {
        ...
        if (mOptions == null) {
            mOptions = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.video_play_bg) // 设置图片在下载期间显示的图片
                    .showImageForEmptyUri(R.drawable.video_play_bg)// 设置图片Uri为空或是错误的时候显示的图片
                    .showImageOnFail(R.drawable.video_play_bg) // 设置图片加载/解码过程中错误时候显示的图片
